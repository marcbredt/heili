...
CREATE TABLE `r_langtext` (
  ...
  CONSTRAINT `r_langtext_ibfk_5` FOREIGN KEY (`rid`) REFERENCES `roles` (`rid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `r_roles` (
  `cid` int(11) NOT NULL,
  `rid` int(11) NOT NULL,
  UNIQUE KEY `cid` (`cid`,`rid`),
  KEY `rid` (`rid`),
  CONSTRAINT `r_roles_ibfk_1` FOREIGN KEY (`cid`) REFERENCES `user` (`cid`),
  CONSTRAINT `r_roles_ibfk_2` FOREIGN KEY (`rid`) REFERENCES `roles` (`rid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-05-24 10:08:26
