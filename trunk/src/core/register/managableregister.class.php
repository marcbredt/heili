...
/**
 * A register implementation to store configurations loaded.
 * @author Marc Bredt
 * @see Register
 */
class ManagableRegister extends Register implements SerializationMethods {
  ...
  public function __wakeup() {
    $this->logger = new \core\util\log\FileLogger(__CLASS__);
  }
